...
dependencies {
    ...
    shadowMe?.invoke("net.kyori:adventure-text-minimessage:4.17.0")
    shadowMe?.invoke("net.kyori:adventure-text-serializer-gson:4.17.0")
    shadowMe?.invoke("net.kyori:adventure-text-serializer-legacy:4.17.0")
}
